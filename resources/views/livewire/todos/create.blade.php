<div>
    <div class="flex items-start space-x-4">
        <div class="min-w-0 flex-1">
            <form wire:submit="saveTodo" class="relative h-full">
                <div
                    class="overflow-hidden rounded-lg shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-sky-600">
                    <label for="title" class="sr-only">Add a todo!</label>
                    <textarea rows="10" name="title" id="title"
                              wire:model="title"
                              class="block w-full resize-none border-0 bg-transparent py-1.5 text-sky-500 font-bold text-xl placeholder:text-sky-400 focus:ring-0 sm:text-sm sm:leading-6 pl-2"
